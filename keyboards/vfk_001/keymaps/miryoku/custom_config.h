...
LCTL_T(KC_A),      LALT_T(KC_S),      LGUI_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
...
KC_F11,            KC_F4,             KC_F5,             KC_F6,             LSFT(LCMD(KC_4)),           U_NA,              KC_LSFT,           KC_LGUI,          KC_LALT,            KC_LCTL,           \
